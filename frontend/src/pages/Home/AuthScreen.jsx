                ...
                <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
                    ...
                    <div className='flex-1 relative'>
                        <div className='relative'>
                            ...
                            <div className='flex items-center gap-2 absolute bottom-5 left-1/2 -translate-x-1/2 w-3/4 lg:w-1/2 h-24 border border-slate-500 rounded-md px-2 bg-black'>
 ...
 <div className='h-2 w-full bg-[#232323]' aria-hidden='true' />
        ...
        <div className='py-10 bg-black text-white'>
                <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
                    {/* left side */}
                    <div className='flex-1 text-center md:text-left'>
                        <h2 className='text-4xl md:text-5xl font-extrabold mb-4'>Watch From Everywhere</h2>
                        <p className='text-lg md:text-xl'>
...
<div className='py-10 bg-black text-white'>
  <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
    ...
    {/* right side */}
    <div className='flex-1 relative'>
      <img src='/kids.png' alt='Kids image' className='mt-4 z-20 relative' />
    </div>
  </div>
</div>
        {/* separator */}
